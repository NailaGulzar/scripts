...
################################################################################
                        ##parse-big-fasta.py##
"""designed to parse the RVDB formatted FASTA headers so that the accessions can pull up the information in the annotaion file using
HIVE-heptagon's Extended Hitby HIVE's tablequery"""
################################################################################
